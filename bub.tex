...
In this paper we focus on networks and networking initiatives that draw on similar openness principles.
We differentiate between shared networks, open access networks and free (libre) networks.
...
As in happens with software, there is a whole spectrum of diversity between totally closed networks and free (libre) networks.
...
We also briefly describe the ``Commons for Europe'' project and the ``Bottom-up Broadband'' initiative that has the goal of studying and promoting networking deployments in which the users are active participants and not mere passive consumers.
...
The model of the \emph{bazaar}, as opposed to the \emph{cathedral} \cite{raymond1999cathedral}, emphasizes the communication with the users and their participation and collaboration in the development process.
...
The person that it is good mounting a pole on top of the roof is not necessarily the one that has server administration skills.
...
The person that enjoys aligning antennas will probably good at it and will do it for pleasure whenever it is needed.
...
In a market economy, the resources are scarce and therefore they can be sold or exchanged to obtain the maximum profit.
...
Reputation is obtained by giving gifts, and for this reasons this model also receive the name of gift-economy \cite{barbrook1998htg}.
...
It works because the participants much more than they receive.
They can receive even without contribution, but still many participants decide to contribute because it \emph{feels good} and like to participate in this reputation system in which those that contribute more receive the recognition of the community.
...
The spirit of the gift economy is often present in mailing lists and gatherings, in which participants uninterestedly help each others in a continuous process of learning.
...
Happy customers spend more money on communication services which is, in turn, benefitial for the service providers.
...
An advantage of this model is that the users then pay lower monthly fees for a better service.
...
This is already quite common, as sharing makes it possible to take advantage of statistical multiplexing as many users are not connected to the network the whole day.

In a second step, the connected networks will start to offer services in the network.
...
In a closed approach, an individual or organization can use a closed solution (closed hardware, closed software) to gather the data that then will be keep secret.
Other alternatives, such as the Air Quality Egg or the Smart Citizen Kit embrace a community-driven solution in which open hardware and open software is used to create the network.
...
\section{The peer-to-peer economic ecosystem}
...
When possible, it is not uncommon that each participate buys her own hardware to be part of the network.
...
For more ambitious initiatives, such as optical fiber networks, the participants need to reach an agreement and advance an important quantity of money to make the deployment possible.
Sometimes, local authorities perceive that there is a value in supporting the deployment of networks and also support this initiatives.

Even though the initial intention is not to make money out of the network, as the network grows in size and importance small companies start to develop around the network.
...
Finally, it is also possible to create companies that sell services, such as Internet access or TV on top of the BuB network.

All this companies are leaded by local enterpreneurs, which also spend their money locally and in this way maintain the wealth of the community.
The small companies that make a leaving on the network have a good incentive in investing in such network, and therefore reinforce the BuB initiative.
...
The situation is not that different from the one existing in the open source ecosystem, in which there are companies that make a living out of open source and generously donate code or employees to the community in order to strengthen the ecosystem.
...
\section{Advantages for research and education}
...
The Bottom-up Broadband project studies and encourages bottom-up networking initiatives.
By bottom-up, we mean that there is a peer-to-peer ingredient and that the users play a more active role than mere consumers.
The project has two differentiated goals.
In the short term, the objective is to run pilots to learn about bottom-up initiatives and learn from them 
...
Wifi, sensor and optical networks are considered in this project and some of projects used as examples in this articles are the ones that have been considered as pilots.
Bottom-up network initiatives are simply another way of creating networks, just like open source is a way of create software and wikis are a way to create encyclopedias.
Bottom-up broadband can complement traditional broadband offers and offer added value such as the possibility of customization, experimentation and education.

\section{Conclusion} \label{sec:conclusion}

In this paper we have covered bottom-up network initiatives, which are characterized by the more active participation of the users than in purely closed solutions.
Obviously, there is a whole spectrum of openness, from the telecom operators encouraging users to share their access points with other customers to community networks.
There is an increasing number of open networks initiatives, and the existing ones are growing in size and complexity.
It is unavoidable to find parallelisms between the open networking initiatives and the open source projects.
The peer-to-peer production model that has been successful in the area of open source is finding its way into other areas, including networking.
