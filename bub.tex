...
Software, hardware and networks are closely knitted together and therefore it makes sense to explore open and free networks by establishing parallelisms with open and free software.
...
Sharing Internet access is not an open/free network work model.
...
In this paper we have discussed open and free networks and how they are similar to free software.
...
\emph{Bottom-up Broadband for Europe} has been created to study, document and promote open and free networks with the ultimate goal of eradicating the digital divide.
