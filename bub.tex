...
We differentiate between Open Access Networks ayered network deployment infrastructure that lowers the entry barriers for new Service Provideds and encourages specialization, and Free (Libre) Networks in which the network is under control of the community.
\end{abstract}
...
Open source is a way of creating and sharing software that has several advantages and areas of applicability.
Nowadays, we find open source software running in all kinds of computing devices, from mobile phones to server farms.
The open source methodology have permitted
