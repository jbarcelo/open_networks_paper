...
The open software and open hardware movements are relatively well established and known.
Contrastingly, there is little discussion on open network initiatives.
Software, hardware and networks are closely knitted together and therefore it makes sense to explore open networks by establishing parallelisms with open software.

The first part of this paper presents a classification of open networks, according to the degree of openness.
Then we study the driving principles behind open networks to see that they are not that different from those found in open software development.
The way of doing that has allowed the growth and the success of open hardware may as well represent the key strength of open networks.
We point out the advantages of the peer to peer production model found in communities
